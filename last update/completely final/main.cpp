...
int main() {
    ...
    if (app.users.empty()) {
        ...
        std::cout << "Welcome! Let's create your account." << std::endl;
        std::cout << "Username: ";
        std::cin >> username;
        std::cout << "Password: ";
        std::cin >> password;
    ...
    while (true) {
        std::cout << "\nMenu:" << std::endl;
        std::cout << "1. Add product to inventory" << std::endl;
        std::cout << "2. Remove product from inventory" << std::endl;
        std::cout << "3. Edit product in inventory" << std::endl;
        std::cout << "4. Display inventory" << std::endl;
        std::cout << "5. Issue invoice" << std::endl;
        std::cout << "6. Add buyer" << std::endl;
        std::cout << "7. Remove buyer" << std::endl;
        std::cout << "8. Display buyer dashboard" << std::endl;
        std::cout << "9. Update exchange rate manually" << std::endl;
