...
#include "../../main_part1/customerlogin.h"
...
QT_MOC_LITERAL(3, 39, 13), // "enabledbutton"
QT_MOC_LITERAL(4, 53, 21) // "on_pushButton_clicked"

    },
    "customerlogin\0on_pushButton_3_clicked\0"
...
void customerlogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        customerlogin *_t = static_cast<customerlogin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject customerlogin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_customerlogin.data,
      qt_meta_data_customerlogin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *customerlogin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_customerlogin.stringdata0))
        return static_cast<void*>(const_cast< customerlogin*>(this));
